We create a dashboard for our users to identify new plans of action on where to build new renewable energy sites. 

When running this after the aiaiay-app, please consider to run:
...
The main source of what helped us build the applicatino was the Material Kit React and the Free Admin dashboarded provided. 
